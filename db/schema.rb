...
ActiveRecord::Schema.define(version: 20141009003401) do
  ...
  add_index "curiosities", ["slug"], name: "index_curiosities_on_slug", unique: true, using: :btree
  add_index "curiosities", ["user_id"], name: "index_curiosities_on_user_id", using: :btree
